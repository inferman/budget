const budgetController = (function() {
  ...
  return {
    ...
    deleteItem: (type, id) => {
      const selectedItemIndex = data.allItems[type].indexOf(data.allItems[type].find(item => item.id === +id))
      data.allItems[type].splice(selectedItemIndex, 1);
...
const controller = (function(budgetCtrl, UICtrl) {
  ...
  const setEventListeners = function() {
    ...
    document.querySelector(UICtrl.getDOMnode('container')).addEventListener('click', ctrlDeleteItem)
